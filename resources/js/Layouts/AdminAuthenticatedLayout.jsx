        ...
        <div className="min-h-screen bg-gray-100">
            <nav className="border-b border-gray-100 bg-red-600">
                                ...
                                <Dropdown>
                                    <Dropdown.Trigger>
                                        <span className="inline-flex rounded-md">
                                            <button
                                                type="button"
                                                className="inline-flex items-center rounded-md border border-transparent bg-red-600 px-3 py-2 text-sm font-medium leading-4 text-white transition duration-150 ease-in-out hover:text-red-200 focus:outline-none"
                                            >
                                                {admin?.name || 'Admin'}
                ...
                >
                    ...
                    <div className="border-t border-red-500 pb-1 pt-4">
                        <div className="px-4">
